...
#         # print("S3_BUCKET:", os.getenv('S3_BUCKET_NAME'))
#         # print("S3_REGION:", os.getenv('AWS_REGION'))
...
S3_BUCKET = "profile-pics-dayoff"
S3_REGION = "eu-west-2"
S3_ACCESS_KEY = "AKIA2NANC2DEAIR4QOK2"
S3_SECRET_KEY = "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"
